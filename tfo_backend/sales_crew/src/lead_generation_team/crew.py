...
class LeadGenerationTeam():
    ...
    def lead_identifier_task(self) -> Task:
        return Task(
            ...
            callback=lambda result: main.task_callback(result=result, task_name="Lead Identification",formate='Analysis report'),
        )
    ...
    def research_analyst_task(self) -> Task:
        return Task(
            ...
            callback=lambda result: main.task_callback(result=result, task_name="Market Research & Analysis",formate='Analysis report'),
        )
    ...
    def social_media_extractor_task(self) -> Task:
        return Task(
            ...
            callback=lambda result: main.task_callback(result=result, task_name="Social Media Data Extraction",formate='social media lead'),
        )
