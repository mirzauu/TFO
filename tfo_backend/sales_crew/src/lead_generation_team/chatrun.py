...
from sales_crew.src.lead_generation_team.chatcrew import LeadGenerationTeam
from sales_crew.src.lead_generation_team.config import (
    QueryClassifier,
...
def process_agent_task(agent_type: AgentType, formatted_prompt: str) -> tuple:
    ...
    task_mapping = {
        AgentType.LEAD_IDENTIFIER: "lead_identifier_task",
        AgentType.RESEARCH_ANALYST: "research_analyst_task",
        AgentType.SOCIAL_MEDIA_EXTRACTOR: "social_media_extractor_task", 
        AgentType.COMPETITOR_ANALYST: "competitor_analyst_task", 
    }
    ...
    format_map = {
        AgentType.LEAD_IDENTIFIER: ("Analysis report", "details", "response"),
        AgentType.RESEARCH_ANALYST: ("Analysis report", "details", "response"),
        AgentType.SOCIAL_MEDIA_EXTRACTOR: ("social media lead", "details", "response"),
        AgentType.COMPETITOR_ANALYST: ("competitor analyst", "details", "response"),
