...
class CrmTeam():
	...
	def follow_up_manager_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Follow-Up Manager",formate='email templates'),
		)
	...
	def feedback_analyst_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Feedback Analyst",formate='Analysis report'),
		)
	...
	def customer_segmentation_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Customer Segmentation Specialist",formate='competitor analyst'),
		)
	...
	def cross_sell_strategist_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Cross-Sell Strategist",formate='competitor analyst'),
		)
	...
	def survey_specialist_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Survey Specialist",formate='survey out'),
		)
