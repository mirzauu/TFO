...
class SocialMediaCrew():
	...
	def content_planner_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Content Planning",formate='sales pitch'),
		)
	...
	def brand_monitor_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Brand Monitoring",formate='competitor analyst'),		
		)
	...
	def influencer_scout_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Influencer Scouting",formate='posts'),	
		)
	...
	def customer_engagement_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Customer Engagement",formate='email templates'),	
	...
	def metrics_analyst_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Performance Metrics Analysis",formate='Analysis report'),
	...
	def hashtag_strategy_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Hashtag Strategy Development",formate='email templates'),
	...
	def campaign_design_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Campaign Design",formate='discription'),	
		)
	...
	def caption_creation_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Caption Creation",formate='discription'),
		)
	...
	def scriptwriting_task(self) -> Task:
		return Task(
			...
			callback=lambda result: main.task_callback(result=result, task_name="Scriptwriting for Social Media",formate='discription'),
		)
